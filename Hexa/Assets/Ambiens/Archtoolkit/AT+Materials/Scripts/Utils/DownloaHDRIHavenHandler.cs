...
namespace ambiens.archtoolkit.atmaterials.utils
{
    ...
    public class DownloadHDRIHavenHandler : MonoBehaviour
    {
        ...
        public static Dictionary<RenderPipelineType, string> materialMaps = new Dictionary<RenderPipelineType, string>() {
        ...
        public static void Get(DownloadsItem downloadsItem, string url, string relativeAssetPath, string assetPath, string name, Action<float> OnProgress, Action<string, DownloadsItem> onComplete)
        {
            ...
            tHandler.StartCoroutine(tHandler.DownloadTexture(downloadsItem, url, relativeAssetPath, assetPath, name, OnProgress, onComplete));
        }
        public IEnumerator DownloadTexture(DownloadsItem downloadsItem, string url, string relativeAssetPath, string assetPath, string name, Action<float> onProgress, Action<string, DownloadsItem> onComplete)
        {
            ...
            else
            {
                ...
                using (WWW www = new WWW(url))
                {
                    ...
                    filepath = assetPath + Path.GetFileNameWithoutExtension(remoteUrl) + Path.GetExtension(remoteUrl);
            ...
            downloadsItem.materialLoaded = GetMaterial(relativeAssetPath + Path.GetFileNameWithoutExtension(url) + Path.GetExtension(url));
